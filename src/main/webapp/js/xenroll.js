...
function loadItrusEnroll() {
    ...
    var ieCenrollObject = "<object id='cenroll' codebase='" + base + "/download" + "/itruscertctl.CAB#version=2,0,0,3' classid='clsid:DD2257CE-4FEE-455A-AD8B-860BEEE25ED6'></object>";
