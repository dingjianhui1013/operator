...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$.getJSON(url,function(data) {
			if(data.newIP != null){
				var info = "<br />上次登录IP："+data.oldIP+"<br />上次一次登陆时间："+data.loginDate+"<br /><br />";
...
<body>
	<div id="main">
					...
					<ul id="menu" class="nav">
						...
						<shiro:hasPermission name="cms:site:select">
							<li class="dropdown"><a class="dropdown-toggle"
								data-toggle="dropdown" href="#">${fnc:getSite(fnc:getCurrentSiteId()).name}<b
									class="caret"></b></a>
		...
		<div class="container-fluid">
			...
			<div id="footer" class="row-fluid">Copyright &copy;
				2014-${fns:getConfig('copyrightYear')}
				${fns:getConfig('productName')}</div>
		</div>
	</div>
