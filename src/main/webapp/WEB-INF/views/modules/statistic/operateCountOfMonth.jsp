		...
		<table id="contentTable"
			...
			<thead>
				<tr>
					...
					<th colspan="16" style="text-align:center; vertical-align: middle;">${appMonthDataList[0].app.appName}</th>
				</tr>
				<tr> 
			...
			<tbody>
				...
				<c:if test="${appMonthData.sealTotal!=0}">
					<tr>
						...
						<td style="text-align:center; vertical-align: middle;" >${appMonthData.addFinance}</td>
						<td style="text-align:center; vertical-align: middle;" >${appMonthData.addContract}</td>
						<td style="text-align:center; vertical-align: middle;" >${appMonthData.addPersonal}</td>
						<td style="text-align:center; vertical-align: middle;" >${appMonthData.addOfficial}</td>
						<td style="text-align:center; vertical-align: middle;" >${appMonthData.renewFinance}</td>
						<td style="text-align:center; vertical-align: middle;" >${appMonthData.renewContract}</td>
						<td style="text-align:center; vertical-align: middle;" >${appMonthData.renewPersonal}</td>
						<td style="text-align:center; vertical-align: middle;" >${appMonthData.renewOfficial}</td>
						<td style="text-align:center; vertical-align: middle;" >${appMonthData.changeFinance}</td>
						<td style="text-align:center; vertical-align: middle;" >${appMonthData.changeContract}</td>
						<td style="text-align:center; vertical-align: middle;" >${appMonthData.changePersonal}</td>
						<td style="text-align:center; vertical-align: middle;" >${appMonthData.changeOfficial}</td>
