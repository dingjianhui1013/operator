...
<script type="text/javascript">
	function cc(obj){
		if($(obj).prop("checked")){
			$("#manMade").attr("style","display:");
		} 
	}
	function bb(obj){
		if($(obj).prop("checked")){
			$("#manMade").attr("style","display:none");
		} 
	}
	...
	function onSubmit(){
		$("#newInfoId").val(getCookie("work_deal_info_reissue"));
		delCookie("work_deal_info_reissue");
		return true;
	}
</script>
</head>
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/work/workDealInfoOperation/reissueFrom?id=${workDealInfo.id}">业务补办</a></li>
	</ul>
	<form:form id="inputForm" action="${ctx}/work/workDealInfoOperation/reissueSave?id=${workDealInfo.id }"
				...
				<table class="table table-striped table-bordered table-condensed">
					<tbody>
						...
						<tr>
							...
							<th>业务类型：</th>
							<td><input type="radio" name="dealInfType" onclick="bb(this)" value="2" checked="checked">遗失补办 
								<input type="radio" name="dealInfType" onclick="cc(this)" value="3">损坏更换
								<input type="checkbox" name="dealInfType1" onclick="dealType(this)" value="1">业务更新</td>
						</tr>
						<tr>
							<th>申请年数：</th>
						...
						<tr id="manMade" style="display: none;">
							<th>人为损坏：</th>
