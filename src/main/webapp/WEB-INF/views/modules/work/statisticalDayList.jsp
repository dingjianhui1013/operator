...
<body>
	...
	<form:form id="searchForm" modelAttribute="workDealInfo"
		...
		<input id="startTime" name="startTime" type="text" readonly="readonly"
			...
			value="<fmt:formatDate value="${startTime}" pattern="yyyy-MM-dd"/>" onblur="changeEndTime()"/>
					&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;
		<input id="btnSubmit" class="btn btn-primary" type="submit" onclick="return sub()"
			...
			<input type="hidden" value="<fmt:formatDate value="${endTime}" pattern="yyyy-MM-dd"/>" id="endTime" name="endTime"/>
	</form:form>
