...
<body>
	...
	<form:form id="inputForm"
		action="${ctx}/work/workPayInfo/updateSavePayInfo" method="POST"
						...
						<tbody>
							...
							<tr>
								<td><c:if test="${chargeAgent.chargeMethodGov==true }">
										<input type="checkbox" value="1" name="methodGov"
											onclick="choose(this)" id="gc" methodval="0">政府统一采购</c:if>
								...
								<td><c:if test="${chargeAgent.chargeMethodContract==true }">
										<input type="checkbox" value="1" name="methodContract"
											onclick="choose(this)" id="cc" methodval="1">合同采购</c:if>
									<c:if test="${chargeAgent.chargeMethodContract!=true }">
										<input type="checkbox">合同采购</c:if></td>
							...
							<tr>
								...
								<td>
									<!-- 本次应收金额 --> <input type="hidden" name="workReceivaMoney"
									id="shouldMoney" disabled="disabled"
									value="${type0+type1+type2+type3+type4+type5+type6 }">
								</td>
							...
							<tr>
								...
								<td><input type="text" name="workPayedMoney"
									id="collectMoney" disabled="disabled" value="0"></td>
								<td></td>
								<td></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="radio" name="userReceipt" value="true"
									checked="checked" id="sff0">是 <input type="radio"
									name="userReceipt" value="false" id="sff1">否</td>
								<td>发票金额：</td>
		...
		<div class="form-actions" style="text-align: center;">
			<shiro:hasPermission name="work:workDealInfo:edit">
				<input id="btnSubmit" class="btn btn-primary" type="submit"
					onclick="return onSubmit()" value="提 交" />&nbsp;</shiro:hasPermission>
