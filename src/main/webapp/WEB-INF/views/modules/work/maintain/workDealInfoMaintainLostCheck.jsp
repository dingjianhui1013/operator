...
<body>
	<ul class="nav nav-tabs">
		...
		<c:if test="${iseditor !='iseditor'}">
			<li class="active"><a href="#">业务补办</a></li>
		</c:if>
		<c:if test="${iseditor =='iseditor'}">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								name="dealInfoType1"><font color="red" style="">遗失补办</font><input type="hidden" value="1" name="dealInfoType1"></c:if>
								<c:if test="${reissue==2}"><input type="checkbox" disabled="disabled" checked="checked" value = "2"
								name="dealInfoType1"><font color="red" style="">损坏更换</font><input type="hidden" value="2" name="dealInfoType1"></c:if>
								&nbsp;&nbsp;
				...
				<table class="table table-striped table-bordered table-condensed">
					<tbody>
						...
						<tr>
							...
							<td class="tdWidth"><input type="text" name="companyName" id="companyName" disabled="disabled"
					...
					<tbody>
						...
						<tr>
							...
							<td class="tdWidth"><input type="text" name="contactPhone"
								...
								value="<fmt:formatNumber pattern="#">${workDealInfo.workUser.contactPhone }</fmt:formatNumber>"  onblur="qxCount('zjtcount')" onfocus="hqcount('contactPhone1','zjtcount')"/><span id="zjtcount" style="  margin-left: 10px"></span> 
							</td>
