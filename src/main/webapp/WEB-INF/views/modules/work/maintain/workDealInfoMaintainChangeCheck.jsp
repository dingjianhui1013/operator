...
.accordion-heading,.table td{width:485px;}
.Wdate{width:206px;}
.btmBorder{border-bottom:1px solid #ddd}
.accordion-heading, .table th{ vertical-align: middle;}
	...
	$(document).ready(function() {
		...
		if("${imgNames}"!=null && "${imgNames}"!=""){
			...
			for(var i = 0;i < str1.length; i++){
				...
				var str ='';
				if(imgstatus==-2){
					str = $("<div class='uploadImgList' style='border-style:solid;border-width:2px;border-color:green' ><img src='"+str1[i].substring(0,str1[i].lastIndexOf('##'))+"' style='width: 100px; height: 80px;' imgRotation='"+canRotation(str1[i])+"'>"+'<p class="uploadImgName">'+getDisplayName(str1[i])+'</p></div>');
				}else{
					str = $("<div class='uploadImgList'><img src='"+str1[i].substring(0,str1[i].lastIndexOf('##'))+"' style='width: 100px; height: 80px;' imgRotation='"+canRotation(str1[i])+"'>"+'<p class="uploadImgName">'+getDisplayName(str1[i])+'</p></div>');
				}
				$("#imgLayer").append(str);
				...
				<table class="table table-striped table-bordered table-condensed">
					<tbody>
							...
							<c:if test="${iseditor =='iseditor'}">
								...
								<shiro:hasPermission name="work:workDealInfo:saomiao">
									<a href="#" data-toggle="modal">
										<input id="scan" class="btn btn-primary smBtn" onclick="scanningInfoEnter(false)" data-toggle="modal" value="扫描录入" />
									</a>
								</shiro:hasPermission>	
								</th>
							</c:if>
						...
						<tr>
							...
							<td class=" "><input type="text" name="configApp" disabled="disabled"
							...
							<td>
									...
									<input type="checkbox" disabled="disabled" checked="checked"
										value="3" name="dealInfoType2"><font >变更证书</font><input
										type="hidden" value="3" name="dealInfoType2">
										
									<c:if test="${reissue==1}"><input type="checkbox" disabled="disabled" checked="checked" value = "1"
								name="dealInfoType1"><font >遗失补办</font><input type="hidden" value="1" name="dealInfoType1"></c:if>
								<c:if test="${reissue==2}"><input type="checkbox" disabled="disabled" checked="checked" value = "2"
								name="dealInfoType1"><font>损坏更换</font><input type="hidden" value="2" name="dealInfoType1"></c:if>
						...
						<tr>
							...
							<th><span class="prompt" style=" display: none;">*</span>申请年数：</th>
							<td class=" "><input type="radio" id="delay" checked="checked"
						...
						<tr>
							<th><span class="prompt" style="  display: none;">*</span>计费策略类型：</th>
							<td class=" ">
							...
							<th>人为损坏：</th>
							<td class=" "><input type="radio" name="manMadeDamage" value="true">是
							 <input type="radio" name="manMadeDamage"value="false">否</td>
						
						</c:if>
						<th><span class="prompt" style="  display: none;">*</span>计费策略模版：</th>
							<td class=" ">
				...
				<table class="table table-striped table-bordered table-condensed">
					<tbody>
						...
						<tr>
							...
							<td class=" "><input type="text" name="companyName" id="companyName"
								maxlength="50" value="${workDealInfo.workCompany.companyName}" />
							</td>
							<th>单位类型：</th>
							<td class=" "><select name="companyType">
						...
						<tr>
							...
							<td class=" "><input type="text" name="comCertficateNumber"
								...
								value="${workDealInfo.workCompany.comCertficateNumber}"  onblur="qxCount('zjcount')" onfocus="hqcount('comCertficateNumber1','zjcount')"/><span id="zjcount" style=" margin-left: 10px"></span></td>
						</tr>
						<tr>
							<th>单位证照有效期：</th>
						...
						<tr>
							...
							<td class="btmBorder" ><input type="text" name="companyMobile" 
								id="companyMobile"
								value="${workDealInfo.workCompany.companyMobile }"  onblur="checkContactMobil(this,'dwtcount')"  onfocus="hqcount('companyMobile','dwtcount')"/><span id="dwtcount" style=" margin-left: 10px"></span></td>
						</tr>
						<tr>
				...
				<table class="table table-striped table-bordered table-condensed">
					<tbody>
						...
						<tr>
							...
							<td class=" "><input type="text" name="contactName" id="contactName1"
								value="${workDealInfo.workUser.contactName }" onblur="setJBRName()" /></td>
							<th>证书持有人证件:</th>
							<td class=" "><select name="conCertType">
						...
						<tr>
							...
							<td class=" "><input type="text" name="conCertNumber"
							...
							<td class=" "><input type="text" name="contacEmail" id="contacEmail" onblur="setJBRMail()"
						...
						<tr>
							...
							<td class=" "><input type="text" name="contactPhone"
						...
						<tr>
							<th>证书持有人性别:</th>
							<td class=" "><input name="contactSex" id="sex0"
				...
				<table class="table table-striped table-bordered table-condensed">
					<tbody>
						...
						<tr>
							...
							<td class="btmBorder"><input type="text" name="pIDCard" id="pIDCard" maxlength="18"
								value="${workDealInfo.workCertInfo.workCertApplyInfo.idCard }"  onblur="qxCount('pIDcount')" onfocus="hqcount('pIDCard','pIDcount')"/><span id="pIDcount" style=" margin-left: 10px"></span></td>
						</tr>
						<tr>
