	...
	$(document).ready(function() {
		...
		if("${imgNames}"!=null && "${imgNames}"!=""){
			...
			for(var i = 0;i < str1.length; i++){
				...
				var str ='';
				if(imgstatus==-2){
					str = $("<div class='uploadImgList' style='border-style:solid;border-width:2px;border-color:green' ><img src='"+str1[i].substring(0,str1[i].lastIndexOf('##'))+"' style='width: 100px; height: 80px;'>"+'<p class="uploadImgName">'+getDisplayName(str1[i])+'</p></div>');
				}else{
					str = $("<div class='uploadImgList'><img src='"+str1[i].substring(0,str1[i].lastIndexOf('##'))+"' style='width: 100px; height: 80px;'>"+'<p class="uploadImgName">'+getDisplayName(str1[i])+'</p></div>');
				}
				$("#imgLayer").append(str);
