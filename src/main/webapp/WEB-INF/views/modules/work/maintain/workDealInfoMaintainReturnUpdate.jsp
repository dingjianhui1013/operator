					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" name="organizationNumber"
								...
								maxlength="20" oninput="count('organizationNumber','zzcount')"/><span id="zzcount"></span></td>
							<th>组织机构代码有效期：</th>
						...
						<tr>
							...
							<td><input type="text" name="comCertficateNumber"
								...
								value="${workDealInfo.workCompany.comCertficateNumber}" oninput="count('comCertficateNumber1','zjhcount')"/><span id="zjhcount"></span></td>
							<th>单位证照有效期：</th>
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" name="contactTel" id="contactTel1"
								maxlength="20" value="${workDealInfo.workUser.contactTel }" oninput="count('contactTel1','ywcount')"/><span id="ywcount"></span>
							</td>
						</tr>
						<tr>
							<th>证书持有人性别:</th>
