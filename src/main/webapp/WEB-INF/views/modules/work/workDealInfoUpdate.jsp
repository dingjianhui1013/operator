...
<script type="text/javascript">
function onSubmit(){
	$("#newInfoId").val(getCookie("work_deal_info_update"));
	delCookie("work_deal_info_update");
	return true;
}
</script>
</head>
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/work/workDealInfo/updateFrom?id=${workDealInfo.id}">业务更新</a></li>
	</ul>
	<form:form id="inputForm" action="${ctx}/work/workDealInfo/saveUpdate"
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="checkbox" disabled="disabled" checked="checked"
								name="dealInfType">更新证书</td>
						</tr>
						<tr>
							<th>申请年数：</th>
							<td><input type="radio" name="year" value="1" checked="checked">1年 <input
								type="radio" name="year" value="2">2年 <input
								type="radio" name="year" value="4">4年</td>
							<th>用户分类：</th>
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" name="pIDCard" disabled="disabled"
								value="${workDealInfo.workCertInfo.workCertApplyInfo.idCard }"  disabled="disabled" /></td>
						</tr>
						<tr>
							<th>申请人邮箱:</th>
