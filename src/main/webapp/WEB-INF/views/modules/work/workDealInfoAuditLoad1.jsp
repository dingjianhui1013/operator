...
<body>
	...
	<form:form id="inputForm" action="${ctx}/work/workPayInfo/auditSavePayInfo" method="POST"
				...
				<table class="table table-striped table-bordered table-condensed"
					...
					<tbody>
						...
						<tr>
							<th>业务类型：</th>
							<td>
								${workType[workDealInfo.dealInfoType]}
								&nbsp;&nbsp;
								
								${workType[workDealInfo.dealInfoType1]}</td>
							<th>年限：</th>
				...
				<div class="span12">
					<table class="table table-striped table-bordered table-condensed"
						...
						<tbody>
							...
							<tr>
								<td><c:if test="${chargeAgent.chargeMethodGov==true }"><input type="checkbox" value="1" name="methodGov" onclick="choose(this)" id="gc"
									>政府统一采购</c:if><c:if test="${chargeAgent.chargeMethodGov!=true }"><input type="checkbox" disabled="disabled"
									>政府统一采购</c:if></td>
								<td><c:if test="${chargeAgent.chargeMethodContract==true }"><input type="checkbox" value="1" name="methodContract" onclick="choose(this)" id="cc"
