...
<body>
	...
	<form:form id="inputForm" modelAttribute="workUser" action="${ctx}/work/workUser/insertWorkUser" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="contactEmail" htmlEscape="false" maxlength="30"  cssClass="required email" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label"><span style="color : red">*</span>&nbsp;移动电话:</label>
			<div class="controls">
				<form:input path="contactPhone" htmlEscape="false" maxlength="11" cssClass="required mobile"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">固定电话:</label>
			<div class="controls">
				<form:input path="contactTel" maxlength="13" class="number"/>
			</div>
		</div>
		<div class="control-group" >
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="conCertNumber" maxlength="18" class="required card"/>
			</div>
		</div>
		<div class="control-group">
