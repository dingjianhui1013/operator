...
<body>
	...
	<form:form id="inputForm" action="${ctx}/work/workPayInfo/reissueSavePayInfo" method="POST"
						...
						<tbody>
							...
							<tr>
								...
								<td><c:if test="${chargeAgent.chargeMethodContract==true }"><input type="checkbox" value="1" name="methodContract" onclick="choose(this)" id="cc" methodval="1"
									...
									>合同采购</c:if></td>
									<td>
									<input type="button" onclick="addPayInfoToList()" class="btn btn-primary" id="settle" value="确认" />
