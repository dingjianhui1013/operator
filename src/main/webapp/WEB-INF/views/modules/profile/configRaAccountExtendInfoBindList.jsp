...
<body>
	...
	<form:form id="searchForm" modelAttribute="configRaAccountExtendInfo"
		action="${ctx}/profile/configRaAccountExtendInfo/bindList" method="post"
		...
		<tbody>
			<c:forEach items="${page.list}" var="configRaAccountExtendInfo">
				<tr>
				    ...
				    <a href="${ctx}/profile/configProduct/bindCertSave?productId=${configProductId}&certId=${configRaAccountExtendInfo.id}">绑定证书模板</a>
