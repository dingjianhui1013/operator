	...
	<div style="overflow: auto;" class="windowHeight" id="scrollBar">
		...
		<table class="table table-striped table-bordered table-condensed" id="tableW">
			...
			<tr>
						...
						<c:if test="${sumList.total.xzqyadd3!=0}"><td>${sum.value.xzqyadd3}</td></c:if>
						...
						<c:if test="${sumList.total.xzgrQadd3!=0}"><td>${sum.value.xzgrQadd3}</td></c:if>
						...
						<c:if test="${sumList.total.xzgrGadd3!=0}"><td>${sum.value.xzgrGadd3}</td></c:if>
						...
						<c:if test="${sumList.total.xzjgadd3!=0}"><td>${sum.value.xzjgadd3}</td></c:if>
						...
						<c:if test="${sumList.total.gxqyadd3!=0}"><td>${sum.value.gxqyadd3}</td></c:if>
						...
						<c:if test="${sumList.total.gxgrQadd3!=0}"><td>${sum.value.gxgrQadd3}</td></c:if>
						...
						<c:if test="${sumList.total.gxgrGadd3!=0}"><td>${sum.value.gxgrGadd3}</td></c:if>
						...
						<c:if test="${sumList.total.gxjgadd3!=0}"><td>${sum.value.gxjgadd3}</td></c:if>
						...
						<c:if test="${sumList.total.updateLostqyNum3!=0}"><td>${sum.value.updateLostqyNum3}</td></c:if>
						...
						<c:if test="${sumList.total.updateLostgrQNum3!=0}"><td>${sum.value.updateLostgrQNum3}</td></c:if>
						...
						<c:if test="${sumList.total.updateLostgrGNum3!=0}"><td>${sum.value.updateLostgrGNum3}</td></c:if>
						...
						<c:if test="${sumList.total.updateLostjgNum3!=0}"><td>${sum.value.updateLostjgNum3}</td></c:if>
						...
						<c:if test="${sumList.total.updateReplaceqyNum3!=0}"><td>${sum.value.updateReplaceqyNum3}</td></c:if>
						...
						<c:if test="${sumList.total.updateReplacegrQNum3!=0}"><td>${sum.value.updateReplacegrQNum3}</td></c:if>
						...
						<c:if test="${sumList.total.updateReplacegrGNum3!=0}"><td>${sum.value.updateReplacegrGNum3}</td></c:if>
						...
						<c:if test="${sumList.total.updateReplacejgNum3!=0}"><td>${sum.value.updateReplacejgNum3}</td></c:if>
						...
						<c:if test="${sumList.total.updateChangeqyNum3!=0}"><td>${sum.value.updateChangeqyNum3}</td></c:if>
						...
						<c:if test="${sumList.total.updateChangegrQNum3!=0}"><td>${sum.value.updateChangegrQNum3}</td></c:if>
						...
						<c:if test="${sumList.total.updateChangegrGNum3!=0}"><td>${sum.value.updateChangegrGNum3}</td></c:if>
						...
						<c:if test="${sumList.total.updateChangejgNum3!=0}"><td>${sum.value.updateChangejgNum3}</td></c:if>
						...
						<c:if test="${sumList.total.updateChangejgNum5!=0}"><td>${sum.value.updateChangejgNum5}</td></c:if> 
						 ...
						 <c:if test="${sumList.total.changeUpdateLostqyNum!=0}"><td>${sum.value.changeUpdateLostqyNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostqyNum2!=0}"><td>${sum.value.changeUpdateLostqyNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostqyNum3!=0}"><td>${sum.value.changeUpdateLostqyNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostqyNum4!=0}"><td>${sum.value.changeUpdateLostqyNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostqyNum5!=0}"><td>${sum.value.changeUpdateLostqyNum5}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrQNum!=0}"><td>${sum.value.changeUpdateLostgrQNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrQNum2!=0}"><td>${sum.value.changeUpdateLostgrQNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrQNum3!=0}"><td>${sum.value.changeUpdateLostgrQNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrQNum4!=0}"><td>${sum.value.changeUpdateLostgrQNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrQNum5!=0}"><td>${sum.value.changeUpdateLostgrQNum5}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrGNum!=0}"><td>${sum.value.changeUpdateLostgrGNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrGNum2!=0}"><td>${sum.value.changeUpdateLostgrGNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrGNum3!=0}"><td>${sum.value.changeUpdateLostgrGNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrGNum4!=0}"><td>${sum.value.changeUpdateLostgrGNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrGNum5!=0}"><td>${sum.value.changeUpdateLostgrGNum5}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostjgNum!=0}"><td>${sum.value.changeUpdateLostjgNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostjgNum2!=0}"><td>${sum.value.changeUpdateLostjgNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostjgNum3!=0}"><td>${sum.value.changeUpdateLostjgNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostjgNum4!=0}"><td>${sum.value.changeUpdateLostjgNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostjgNum5!=0}"><td>${sum.value.changeUpdateLostjgNum5}</td></c:if> 
						
						 <c:if test="${sumList.total.changeUpdateReplaceqyNum!=0}"><td>${sum.value.changeUpdateReplaceqyNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplaceqyNum2!=0}"><td>${sum.value.changeUpdateReplaceqyNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplaceqyNum3!=0}"><td>${sum.value.changeUpdateReplaceqyNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplaceqyNum4!=0}"><td>${sum.value.changeUpdateReplaceqyNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplaceqyNum5!=0}"><td>${sum.value.changeUpdateReplaceqyNum5}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrQNum!=0}"><td>${sum.value.changeUpdateReplacegrQNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrQNum2!=0}"><td>${sum.value.changeUpdateReplacegrQNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrQNum3!=0}"><td>${sum.value.changeUpdateReplacegrQNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrQNum4!=0}"><td>${sum.value.changeUpdateReplacegrQNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrQNum5!=0}"><td>${sum.value.changeUpdateReplacegrQNum5}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrGNum!=0}"><td>${sum.value.changeUpdateReplacegrGNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrGNum2!=0}"><td>${sum.value.changeUpdateReplacegrGNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrGNum3!=0}"><td>${sum.value.changeUpdateReplacegrGNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrGNum4!=0}"><td>${sum.value.changeUpdateReplacegrGNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrGNum5!=0}"><td>${sum.value.changeUpdateReplacegrGNum5}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacejgNum!=0}"><td>${sum.value.changeUpdateReplacejgNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacejgNum2!=0}"><td>${sum.value.changeUpdateReplacejgNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacejgNum3!=0}"><td>${sum.value.changeUpdateReplacejgNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacejgNum4!=0}"><td>${sum.value.changeUpdateReplacejgNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacejgNum5!=0}"><td>${sum.value.changeUpdateReplacejgNum5}</td></c:if> 
						</c:if>
						</tr>
						</c:if>
			...
			<tr> 
						...
						<c:if test="${sumList.total.changeUpdateLostqyNum!=0}"><td>${sumList.total.changeUpdateLostqyNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostqyNum2!=0}"><td>${sumList.total.changeUpdateLostqyNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostqyNum3!=0}"><td>${sumList.total.changeUpdateLostqyNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostqyNum4!=0}"><td>${sumList.total.changeUpdateLostqyNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostqyNum5!=0}"><td>${sumList.total.changeUpdateLostqyNum5}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrQNum!=0}"><td>${sumList.total.changeUpdateLostgrQNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrQNum2!=0}"><td>${sumList.total.changeUpdateLostgrQNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrQNum3!=0}"><td>${sumList.total.changeUpdateLostgrQNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrQNum4!=0}"><td>${sumList.total.changeUpdateLostgrQNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrQNum5!=0}"><td>${sumList.total.changeUpdateLostgrQNum5}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrGNum!=0}"><td>${sumList.total.changeUpdateLostgrGNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrGNum2!=0}"><td>${sumList.total.changeUpdateLostgrGNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrGNum3!=0}"><td>${sumList.total.changeUpdateLostgrGNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrGNum4!=0}"><td>${sumList.total.changeUpdateLostgrGNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostgrGNum5!=0}"><td>${sumList.total.changeUpdateLostgrGNum5}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostjgNum!=0}"><td>${sumList.total.changeUpdateLostjgNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostjgNum2!=0}"><td>${sumList.total.changeUpdateLostjgNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostjgNum3!=0}"><td>${sumList.total.changeUpdateLostjgNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostjgNum4!=0}"><td>${sumList.total.changeUpdateLostjgNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateLostjgNum5!=0}"><td>${sumList.total.changeUpdateLostjgNum5}</td></c:if> 
						
						<c:if test="${sumList.total.changeUpdateReplaceqyNum!=0}"><td>${sumList.total.changeUpdateReplaceqyNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplaceqyNum2!=0}"><td>${sumList.total.changeUpdateReplaceqyNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplaceqyNum3!=0}"><td>${sumList.total.changeUpdateReplaceqyNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplaceqyNum4!=0}"><td>${sumList.total.changeUpdateReplaceqyNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplaceqyNum5!=0}"><td>${sumList.total.changeUpdateReplaceqyNum5}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrQNum!=0}"><td>${sumList.total.changeUpdateReplacegrQNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrQNum2!=0}"><td>${sumList.total.changeUpdateReplacegrQNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrQNum3!=0}"><td>${sumList.total.changeUpdateReplacegrQNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrQNum4!=0}"><td>${sumList.total.changeUpdateReplacegrQNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrQNum5!=0}"><td>${sumList.total.changeUpdateReplacegrQNum5}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrGNum!=0}"><td>${sumList.total.changeUpdateReplacegrGNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrGNum2!=0}"><td>${sumList.total.changeUpdateReplacegrGNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrGNum3!=0}"><td>${sumList.total.changeUpdateReplacegrGNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrGNum4!=0}"><td>${sumList.totalchangeUpdateReplacegrGNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacegrGNum5!=0}"><td>${sumList.total.changeUpdateReplacegrGNum5}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacejgNum!=0}"><td>${sumList.total.changeUpdateReplacejgNum}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacejgNum2!=0}"><td>${sumList.total.changeUpdateReplacejgNum2}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacejgNum3!=0}"><td>${sumList.total.changeUpdateReplacejgNum3}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacejgNum4!=0}"><td>${sumList.total.changeUpdateReplacejgNum4}</td></c:if>
						<c:if test="${sumList.total.changeUpdateReplacejgNum5!=0}"><td>${sumList.total.changeUpdateReplacejgNum5}</td></c:if> 
						</c:if>
			</tr>
		</table>
		</div>
