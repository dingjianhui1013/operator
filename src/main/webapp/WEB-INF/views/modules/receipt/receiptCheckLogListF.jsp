...
<body>
	<ul class="nav nav-tabs">
		<li ><a href="${ctx}/receipt/receiptCheckLog/li">盘点管理</a></li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<tbody>
		<c:forEach items="${page.list}" var="receiptCheckLog">
			<tr>
				...
				<c:if test="${receiptCheckLog.receiptDepotInfo.id==1}">
						<table>
							<c:forEach items="${receiptCheckLog.lastsStrings }" var="last"  >
								<tr>
									<td  style="border: none; text-align: right;">${last.receiptType.typeName }元</td>
									<td style="border: none; text-align: right;">${last.count }张
									</td>
								</tr>
							</c:forEach>
							<tr>
				...
				<td>
					<c:if test="${receiptCheckLog.receiptDepotInfo.id==1}">
						<table>
							<c:forEach items="${receiptCheckLog.inStrings }" var="in"  >
								<tr>
									<td  style="border: none; text-align: right;">${in.receiptType.typeName }元</td>
									<td style="border: none; text-align: right;">${in.count }张
									</td>
								</tr>
							</c:forEach>
							<tr>
				...
				<c:if test="${receiptCheckLog.receiptDepotInfo.id==1}">
						<table>
							<c:forEach items="${receiptCheckLog.outStrings }" var="out"  >
								<tr>
									<td  style="border: none; text-align: right;">${out.receiptType.typeName }元</td>
									<td style="border: none; text-align: right;">${out.count }张
									</td>
								</tr>
							</c:forEach>
							<tr>
				...
				<c:if test="${receiptCheckLog.receiptDepotInfo.id==1}">
						<table>
							<c:forEach items="${receiptCheckLog.yuStrings }" var="yu"  >
								<tr>
									<td  style="border: none; text-align: right;">${yu.receiptType.typeName }元</td>
									<td style="border: none; text-align: right;">${yu.count }张
									</td>
								</tr>
							</c:forEach>
							<tr>
				...
				<c:if test="${receiptCheckLog.receiptDepotInfo.id==1}">
						<table>
							<c:forEach items="${receiptCheckLog.afterStrings }" var="after"  >
								<tr>
									<td  style="border: none; text-align: right;">${after.receiptType.typeName }元</td>
									<td style="border: none; text-align: right;">${after.count }张
									</td>
								</tr>
							</c:forEach>
							<tr>
				...
				<td><fmt:formatDate value="${receiptCheckLog.startDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td><fmt:formatDate value="${receiptCheckLog.endDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
