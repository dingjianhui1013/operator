...
<body>
	<ul class="nav nav-tabs">
		...
		<li  class="active"><a href="${ctx}/work/customer/insertCustomerFrom?id=${workDealInfo.id}">新增用户</a></li>
	</ul><br/>
	<form name = "customerInsert" id = "inputForm" action ="${ctx}/work/customer/insertComCustomer"  class="form-horizontal" method="post">
