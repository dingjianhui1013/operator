...
<body>
	...
	<form name = "customerInsert" id = "inputForm" action ="${ctx}/work/customer/insertComCustomerT"  class="form-horizontal" method="post">
		<tags:message content="${message}"/>
		<input type = "hidden" name = "workCompanyId" value = "${workUser.workCompany.id}"/>
		<input type = "hidden" name = "state" value = "1"/>
		<div class="control-group">
			<label class="control-label">服务对象:</label>
			<div class="controls">
				${workUser.workCompany.companyName }
			</div>
		</div>
		<div class="control-group">
