...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/work/workLog/">工作记录列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="workLog" action="${ctx}/work/workLog/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="work:workLog:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
