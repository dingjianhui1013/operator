...
<script src="${ctxStatic}/iLetter/js/jquery-1.8.3.min.js" type="text/javascript"></script>
...
<script src="${ctxStatic}/js/bind.js" type="text/javascript"></script>
<script src="${ctxStatic}/js/doInstallCert.js" type="text/javascript"></script>
