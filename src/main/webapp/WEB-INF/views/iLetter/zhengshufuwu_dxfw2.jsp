	...
	var url = "${ctxILetter}/enroll/status"+"?_="+new Date().getTime();
	 $.getJSON(url,function(data){
		if(data.status=="1"){
			...
			window.location.href="${ctxILetter}/enroll/dxfw2Nextform?certSn="+Certsn;
		}else{
...
<div class="main2">
   <div class="zsfw_gxgx_top">
      ...
      <div class="zsfw_dxfw_step2 fl"></div>
    <div class="btn_fanhuizsfw fl"><a href="javascript:window.history.go(-2)"></a></div>
   </div>
   <div class="clear"></div>
   <div class="zsfw_gxgx_bd">
   		<div class="zsfw_js_step2_c hong">请下载<a href="${ctxILetter}/enroll/downloadDoc?fileName=apply.docx" target="_blank" class="ablue">《数字证书业务申请表》</a>填写。<br />您办理<span style="color:#0054fd; font-weight:bold;">${appName }</span>的应用可以通过查看网点就近选择任一网点进行办理
     	</div>
     	<div class="btn_sqdx">
