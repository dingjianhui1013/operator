...
function setCount() {
	...
	if(timeout==80&&zzStatus==0){
		...
		$.getJSON(updateUrl,function(res) {
			window.location.href="${ctxILetter}/enroll/bgfw4Nextform?id=${workDealInfo.id}";
		});
	}
	...
	if (timeout > 100) {
		...
		if(keystutus==1){
			document.getElementById('play3').innerHTML = "变更完成";
		}else{
			document.getElementById('play3').innerHTML = "变更失败";
		}
	}
	if(jinduStatus==1){
...
<div class="main2">
   <div class="zsfw_gxgx_top">
      ...
      <div class="zsfw_bgfw_step4 fl"></div>
   ...
   <div class="zsfw_gxgx_bd">
    <div id="jindutiao" class="zsfw_gxgx_3info3" style="padding-top:70px;display:none" >
			...
			<div id="play3" style="margin-top:-19px;margin-left:100px;left: 80px; z-index: 5;top: 0px; line-height:19px;">正在变更...请勿拨出USBKEY！</div>
