...
Init: function () {
        ...
        if (document.getElementById('iTrusPTA_ie') != null) {
            return true;
				...
				var obj = "<object id='iTrusPTA_ie' codebase='download/certctl.CAB#version=2,5,5,28' style='visibility: hidden' classid='clsid:F1F0506B-E2DC-4910-9CFC-4D7B18FEA5F9' viewastext></object>"
 ...
 */
SignMessage:function (plainType,signedType,detached,plainData,cert){
	var signopt=0;
	var signedData = null;
	//设置原文的类型标识
	if(plainType=="base64"){
 ...
 */
VerifySignature:function (msgType,signedType,detached,plainData,signedData){
	var signopt=0;
	//设置原文的类型标识
	if(msgType=="base64"){
		signopt=MSG_BASE64;
