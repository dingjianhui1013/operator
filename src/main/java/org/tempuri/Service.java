 ...
 * 2016-06-01T16:38:16.988+08:00
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "Service", 
                  wsdlLocation = "file:/D:/workspace/operator-trunk/src/main/resources/smswebservice.wsdl",
...
public class Service extends javax.xml.ws.Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/workspace/operator-trunk/src/main/resources/smswebservice.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/workspace/operator-trunk/src/main/resources/smswebservice.wsdl");
        }
        WSDL_LOCATION = url;
    }
