...
import cn.topca.security.bc.jcajce.JcaJceHelper;
...
public class EnvelopedDataHelper {
    ...
    static {
        ...
        BASE_CIPHER_NAMES.put(CMSAlgorithm.SM4, "SM4");
        ...
        CIPHER_ALG_NAMES.put(CMSAlgorithm.SM4, "SM4/CBC/PKCS5Padding");
        ...
        CIPHER_ALG_NAMES.put(CMSAlgorithm.SM4, "SM4Mac");
    }
    ...
    AlgorithmParameters generateParameters(ASN1ObjectIdentifier encryptionOID, SecretKey encKey, SecureRandom rand)
        ...
        try {
            ...
            if (CMSEnvelopedDataGenerator.RC2_CBC.equals(encryptionOID.getId())) {
                byte[] iv = new byte[8];
