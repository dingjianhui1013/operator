...
public class CMSSignedGenerator {
    ...
    public static final String ENCRYPTION_SM2 = GMObjectIdentifiers.sm2.getId();
    ...
    protected String getEncOID(
        ...
        } else if ("ECSM2".equalsIgnoreCase(key.getAlgorithm()) || "SM2".equalsIgnoreCase(key.getAlgorithm())) {
            if (!digestOID.equals(GMObjectIdentifiers.sm3.getId())) {
                throw new IllegalArgumentException("can't mix SM2 with anything but SM3 digests");
            }
            return ENCRYPTION_SM2;
     ...
     * @throws org.bouncycastle.cms.CMSException     if an issue occurse transforming data from the CertStore into the message
