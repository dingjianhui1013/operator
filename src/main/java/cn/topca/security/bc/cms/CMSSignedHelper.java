...
class CMSSignedHelper {
    ...
    static {
        ...
        addEntries(GMObjectIdentifiers.sm3withSM2, "SM3", "SM2");
        addEntries(GMObjectIdentifiers.sha1withSM2, "SHA1", "SM2");
        addEntries(GMObjectIdentifiers.sha256withSM2, "SHA256", "SM2");
        addEntries(GMObjectIdentifiers.sm3withRSA, "SM3", "RSA");
        addEntries(GMObjectIdentifiers.sm3withRSA, "SHA1", "RSA");
        addEntries(GMObjectIdentifiers.sm3withRSA, "SHA256", "RSA");
                ...
                try {
                    ...
                    if (obj instanceof ASN1TaggedObject) {
                        ...
                        if (tagged.getTagNo() == 2) {
                            certs.add(new X509AttributeCertificateHolder(ASN1Sequence.getInstance(tagged, false).getEncoded()));
                        }
                    }
