 ...
 */
package com.itrus.ca.modules.sys.interceptor;
...
import com.itrus.ca.modules.sys.dao.LogDao;
...
//			}
//		}
//		System.out.println("最大内存: "+Runtime.getRuntime().maxMemory()+", 已分配内存: "+ Runtime.getRuntime().totalMemory()+", 已分配内存中的剩余空间: "+
