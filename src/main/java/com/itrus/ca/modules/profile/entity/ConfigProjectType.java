...
//	@SequenceGenerator(name="COMMON_SEQUENCE",sequenceName="COMMON_SEQUENCE")
	@SequenceGenerator(name="CONFIG_PROJECT_TYPE_SEQUENCE",allocationSize=1,initialValue=1,sequenceName="CONFIG_PROJECT_TYPE_SEQUENCE")
	@Id 
	@GeneratedValue(generator = "CONFIG_PROJECT_TYPE_SEQUENCE",strategy=GenerationType.SEQUENCE)
	public Long getId() {
		return this.id;
	}
