 ...
 * @version 2014-06-13
 */
public interface WorkDealInfoDao extends WorkDealInfoDaoCustom, CrudRepository<WorkDealInfo, Long> {
	@Modifying
	@Query("update WorkDealInfo set delFlag='" + WorkDealInfo.DEL_FLAG_DELETE + "' where id = ?1")
	...
	@Modifying
	@Query("From WorkDealInfo w where w.keySn=?1 and w.certSn =?2 and delFlag = "+WorkDealInfo.DEL_FLAG_NORMAL)
 ...
 */
@Component
class WorkDealInfoDaoImpl extends BaseDaoImpl<WorkDealInfo> implements WorkDealInfoDaoCustom {
