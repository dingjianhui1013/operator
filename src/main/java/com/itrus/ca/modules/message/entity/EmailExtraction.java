...
//	@SequenceGenerator(name="MESSAGE_EMAIL_EXTRACTION_SEQUENCE",sequenceName="MESSAGE_EMAIL_EXTRACTION_SEQUENCE")
//	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "MESSAGE_EMAIL_EXTRACTION_SEQUENCE")
	public Long getId() {
		return id;
	}
