...
import com.itrus.ca.modules.sys.utils.MailAuthenticator;
...
public class MailSend {
	...
	public static void main(String[] args) {
		...
		mailSend.setAuth("879854705", "woshishe");
		mailSend.setServer("smtp.qq.com");
		String server = new String("smtp.qq.com");
		String[] ss = server.split("\\.");
		String fromUser = "879854705@"+ss[ss.length-2]+"."+ss[ss.length-1];
		mailSend.setSSLSecurity("465");
		mailSend.setForm(fromUser);
		mailSend.sendMail("879854705@qq.com", null, "测试ssl", "明天下午出去玩啊");
//		mailSend.set
	}
}
