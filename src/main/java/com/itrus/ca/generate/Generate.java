...
import com.itrus.ca.common.utils.FileUtils;
import com.itrus.ca.common.utils.FreeMarkers;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/itrus/ca/generate/template", "/", separator);
